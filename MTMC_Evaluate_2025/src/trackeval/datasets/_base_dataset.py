        ...
        for t, (gt_ids_t, tracker_ids_t) in enumerate(zip(gt_ids, tracker_ids)):
            if len(tracker_ids_t) > 0:
                ...
                if np.max(counts) != 1:
                    ...
                    print(Back.LIGHTRED_EX + "WARNING!!!!!!! DUPLICATE SINGLE CAMERA ID IN PREDICTION!!!!! Evaluation will resume, but be aware of:" + Style.RESET_ALL)
                    print(exc_str)
            ...
            if len(gt_ids_t) > 0:
                ...
                if np.max(counts) != 1:
                    ...
                    print(Back.LIGHTRED_EX + "WARNING!!!!!!! DUPLICATE SINGLE CAMERA ID IN GROUND TRUTH!!!!! Evaluation will resume, but be aware of:" + Style.RESET_ALL)
                    print(exc_str)
