...
sources = {
        ...
        # Test
        'scene_061': sorted([os.path.join('/home/hoantv/AIC2024_Track1_Nota/data/frames/test/scene_061', p) for p in os.listdir('/home/hoantv/AIC2024_Track1_Nota/data/frames/test/scene_061')]),
        ...
        'scene_071': sorted([os.path.join('/home/hoantv/AIC2024_Track1_Nota/data/frames/test/scene_071', p) for p in os.listdir('/home/hoantv/AIC2024_Track1_Nota/data/frames/test/scene_071')]),
        ...
        'scene_081': sorted([os.path.join('/home/hoantv/AIC2024_Track1_Nota/data/frames/test/scene_081', p) for p in os.listdir('/home/hoantv/AIC2024_Track1_Nota/data/frames/test/scene_081')]),
...
cam_ids = {
    ...
    # Test
    'scene_061': sorted([int(cam.split('_')[-1]) for cam in os.listdir('/home/hoantv/AIC2024_Track1_Nota/data/videos/test/scene_061') if cam.startswith('camera_')]),
    ...
    'scene_071': sorted([int(cam.split('_')[-1]) for cam in os.listdir('/home/hoantv/AIC2024_Track1_Nota/data/videos/test/scene_071') if cam.startswith('camera_')]),
    ...
    'scene_081': sorted([int(cam.split('_')[-1]) for cam in os.listdir('/home/hoantv/AIC2024_Track1_Nota/data/videos/test/scene_081') if cam.startswith('camera_')]),
